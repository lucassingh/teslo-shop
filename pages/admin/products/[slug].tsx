...
const ProductAdminPage: FC<Props> = ({ product }) => {
    ...
    const onNewtag = () => {
        ...
        if(currentTags.includes(newTag)) return; //ya existe ese tag
    ...
    const onSubmit = async(form: FormData) => {
        if(form.images.length < 2 ) return alert('Es necesario cargar 2 imagenes')
        ...
        try {
            const {data} = await tesloApi({
                url: '/admin/products',
                method: form._id ? 'PUT' : 'POST', //si hay un id es actualizar y si no crear
                data: form
            })
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        <TextField
                            ...
                            {...register('inStock', {
                                required: 'Este campo es requerido',
                                minLength: { value: 0, message: 'Mínimo 2 caracteres' }
                            })}
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        <Box display='flex' flexDirection="column">
                            ...
                            <input
                                ...
                                type='file'
                                multiple
                                accept='image/png, image/gif, image/jepg'
                                style={{display:'none'}}
